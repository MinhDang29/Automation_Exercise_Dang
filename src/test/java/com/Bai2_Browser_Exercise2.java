...
public class Bai2_Browser_Exercise2 extends BasicTest {
    @Test()
    public void TC_01_Display() throws Exception {
        // Launch website
    ...
    @Test()
    public void TC_02_Enabled() throws Exception {
        // Launch website
        String url = "https://live.techpanda.org/";
        driver.get(url);
        Assert.assertEquals(driver.getCurrentUrl(), url);
    ...
    @Test()
    public void TC_03_Select() throws Exception {
        String url = "https://live.techpanda.org/";
        driver.get(url);
    ...
    @Test()
    public void TC_04_Mailchimp() throws Exception {
        // Launch website
        String url = "https://live.techpanda.org/";
        driver.get(url);
